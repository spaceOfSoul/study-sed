...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        # BatchNorm에 bias가 포함되어 있으므로, conv2d는 bias=False
...
class ResNet(nn.Module):
    def __init__(self, n_in_channel, activation="relu", conv_dropout=0,
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(n_in_channel, 64, kernel_size=7, stride=2, padding=3, bias=False),
            nn.BatchNorm2d(64),
            nn.ReLU(),
        ...
        self.fc = nn.Linear(512 * block.expansion, nb_filters[-1])
    ...
    def load_state_dict(self, state_dict, strict=True):
        """Load state dict safely for the entire model."""
